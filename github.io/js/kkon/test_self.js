//서열, 배려, 어린 세대 무시, 자기 중심 사고, 비판 수용력
var a = 0;
var b = 0;
var c = 0;
var d = 0;
...
{
    var arrQuestion = [
        "당신은 동아리 모임에 처음 참석했습니다. 당신 옆자리에는 딱 봐도 어려보이는 학생 한 명이 앉아있습니다. 당신은 먼저 다가가 친해지려고 합니다. 이 때 당신의 첫 인사는?", //1
        "어느덧 동아리에서 중요한 직책을 맡게 된 당신. 요즘들어 후배들이 당신이 시키는 일을 잘 따르지 않는 것 같습니다.  후배들이 뭔가 불만이 쌓인것 같은 느낌을 받은 당신. 어떻게 하시겠습니까?", //2
        "알고보니 동아리이 아끼는 선배와 후배가 의견차이로 작은 다툼이 있었던게 문제였다. 당신은 아끼는 두 사람의 화해를 시키려고합니다. 당신의 선택은?", //3
        "당신의 노력으로 동아리는 성공적이다! 오늘은 처음들어온 멤버들과 첫 모임이 있는 날, 그 중 부쩍 말 수가 적은 친구가 보인다. 당신은 그 친구가 다른 사람들과 친해질 수 있게 말을 시켜보려고 한다. 당신의 선택은?", //4
        "모임은 한창 무르익어 즐거운 대화가 오간다. 옆에서는 당신이 잘 아는 주제로 대화중인데, 이 때 당신의 반응은?", //5
        "동아리 멤버 중에는 남들보다 열심히 하지 않거나 부족한 멤버들이 있기 마련. 당신은 이들까지 잘 챙겨내 보려고한다. ", //6
        "동아리 활동 중, 친한 동생이 쉬워보이는 일을 가지고 낑낑대고 있다. 당신의 선택은?", //7
        "간만에 친구들과 피시방에 간 당신. 옆자리에 시끄럽게 떠들며 게임하는 어린 친구들이 보입니다. 당신의 행동은?", //8
        "당신의 얘기 후 잠깐 조용해진 친구들은 시간이 지나자 슬슬 다시 떠들기 시작합니다. 이 때 당신의 반응은?", //9
        "계속되는 시험과 과제로 지친 당신. 오랜만에 만난 친구와 카페에 갔다. 친구가 요즘 사는게 힘들다며 당신에게 하소연을 합니다. 이때 당신의 생각은?", //10
        "알고보니 친구가 힘든 이유는 연애 문제였습니다. 연인의 행동이 문제였는데요, 당신은 친구에게 조언을 해주려고 합니다.", //11
        "새학기가 시작되었습니다. 새로운 친구를 사귈 생각에 들뜬 당신! 처음보는 친구와 짝이 되었는데, 공책이 모두 애니 캐릭터네요.(또는 당신이 전혀 관심없는 취미) 당신의 생각은?", //12
        "쉬는시간, 친구와 단 둘이 매점에 가게 된 당신. 준비한 회심의 개그를 날립니다! 그런데 친구의 표정에 변화가 없네요. 이 때 당신의 생각은?", //13
        "평소 팀게임을 즐기는 당신. 당신의 노력에도 불구하고 당신의 스코어는 팀원들에 비해 굉장히 저조하다. 팀원 중 한명이 당신을 비판하기 시작하는데 이때 당신의 행동은?", //14
        "어느 날 수업시간, 평소 당신과 잘 맞지 않던 친구가 당신의 의견을 많은 사람들 앞에서 비판합니다. 창피해진 당신. 반응은?", //15
    ];
    var arrAnswer_1 = [
    ...
    var arrAnswer_2 = [
        ...
        "ㅇㅇ은 무슨 애니 좋아해?", //4
        "나도 그거 아는 건데.. 존나 그거 아닌데.. 내 생각이 맞는데..(속으로만)", //5
...
window.onload = function () {
    ...
    function result() {
        ...
        document.querySelector("#resultBox>a").setAttribute("href", "/kkon/result/result"+alpa+".html" + param);
    }
}
