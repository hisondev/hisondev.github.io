...
그만큼 저는 개발에 몰입하고 있었습니다.`,
  t2015:
`제가 만든 게임을 친구에게 시켜 보고 피드백을 받아 수정하며, 커뮤니티 웹사이트에 올려 사람들과 공유하면서 개발의 즐거움을 알게 된 것 같습니다.`,
  t2020:
...
둘째, 저는 어떤 일을 하든 매우 진지하게 임하는 사람입니다.
어디에서 어떤 업무를 하든, 시스템 전체를 우선적으로 이해하려 노력합니다.
작은 이슈에도 전체적인 구조를 고려해 문제의 근본적인 해결책을 찾습니다.
나름의 사회적 경험이 많으며, 근무하는 곳마다 상사로부터 “이 일에 진심으로 고민해 보는 사람”이라는 말을 자주 들었습니다.
자기 어필을 하자면,
대학 시절 학원 아르바이트를 하며 원장님께 학원 강사 진로를 권유받았고,
졸업 시 학과장 교수님께서는 제게 본인 연구실 대학원생으로 진로를 정하면 학자금 대출을 대신 갚아주겠다는 말씀을 하셨습니다.
학사장교 시절 대대장님께서는 장기 복무를 권유하셨고,
개발자로서는 ERP 고도화 프로젝트에 투입되어, 종료 후 운영팀에서 계속 일해 달라는 PL님의 요청으로
1년 단위 계약으로 약 5년간 근무했습니다.

셋째, 저는 ‘가성비 좋은 개발자’라고 자신 있게 말할 수 있습니다.
비전공자로 시작해 첫 회사의 연봉은 높지 않았지만, 빠르게 실력을 인정받고 1년 후 프리랜서로 전환하여 연봉을 두 배로 올렸습니다.
어린 시절부터 이공계에 강하고 문과 계열에는 약했습니다.
특히 과학 탐구 영역을 좋아했으며, 시스템을 이해하고 파악하는 능력이 남들보다 뛰어나다고 생각합니다.
요즘은 인공지능을 적극적으로 활용해 더 빠르고 효율적인 성과를 내고 있습니다.
본 프로젝트에서도 ChatGPT와 Gemini를 적극 활용했습니다.
조금 과장하자면, 설계와 초기 소스 구조, 프로젝트 콘셉트만 제가 만들고 나머지는 인공지능이 작성했으며, 저는 검증을 맡았다고 할 수 있습니다.
